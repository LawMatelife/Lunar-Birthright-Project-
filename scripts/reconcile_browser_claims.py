...
def main() -> int:
    ...
    for storage_name, storage_key, value in raw_entries:
        for obj in walk(value):
            ...
            # Require at least one stable identifier OR email plus one claim attribute.
            ...
            # Multiple marker types can legitimately refer to the same user/plot/cert chain.
            # Ambiguity is reserved for conflicting identifiers that point at unrelated users.
            user_roots = set()
